              ...
              <div className="relative bg-neutral-900 border border-neutral-800 rounded-3xl p-8 md:p-16 overflow-hidden">
                ...
                >
                  <div className="lg:col-span-1 space-y-12 text-right">
                    ...
                    <FeaturePoint number="02" title="Develop New Skills">
                      Gain valuable experience in leadership, communication, and
                      project management.
                    </FeaturePoint>
                  </div>
                  <motion.div
                  ...
                  <div className="lg:col-span-1 space-y-12 text-left">
                    ...
                    <FeaturePoint number="04" title="Flexible Commitment">
                      Find roles that fit your schedule, from one-day events to
                      ongoing projects.
                    </FeaturePoint>
                  </div>
                </motion.div>
