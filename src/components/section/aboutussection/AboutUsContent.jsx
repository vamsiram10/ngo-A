        ...
        <div className="flex justify-around items-center bg-[#fb64b6]/10 rounded-xl shadow-md hover:shadow-lg transition">
          <div className="flex-1/2">
            ...
            <p className="mx-auto px-2 text-center leading-relaxed text-white text-lg sm:px-14">
              ...
              <br />
              <br />
              In November 2024, we officially registered as an NGO, allowing us
        ...
        <div className="mt-16 sm:mt-20 md:mt-24 mx-20 lg:mt-32">
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-8 px-2 sm:gap-8 mt-10 px-0">
            {team.map((member, index) => (
              <div
                key={index}
                className="p-5 w-[85vw] text-center bg-[#fb64b6]/10 rounded-xl shadow-md transition-transform duration-300 hover:scale-105 hover:shadow-lg sm:p-6 w-[280px] md:w-[300px] lg:w-[320px]"
              >
                <img
                  src={member.img}
                  alt={member.name}
                  className="object-cover mx-auto mb-4 w-24 h-24 rounded-full border-4 border-[#fb64b6] sm:h-28 w-28"
                />
