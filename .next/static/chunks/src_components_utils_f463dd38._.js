...
"[project]/src/components/utils/roundedpages/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$libs$2f$stats$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/examples/jsm/libs/stats.module.js [app-client] (ecmascript)");
...
function HomePage() {
    ...
    const planeGroupRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const planes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
            ...
            const camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PerspectiveCamera"](60, width / height, 0.1, 1000);
            ...
            // Stats
            const stats = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$libs$2f$stats$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]();
            ...
            for(let i = 0; i < numPlanes; i++){
                ...
                const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PlaneGeometry"](1.6, 0.9);
            ...
            // Mouse move event
            const onMouseMove = {
                "HomePage.useEffect.onMouseMove": (e)=>{
                    mouse.current.x = e.clientX / width * 2 - 1;
                    mouse.current.y = -(e.clientY / height) * 2 + 1;
                }
            }["HomePage.useEffect.onMouseMove"];
            window.addEventListener("mousemove", onMouseMove);
            // Mouse wheel scroll
            const onWheel = {
                "HomePage.useEffect.onWheel": (event)=>{
                    const delta = event.deltaY * 0.005;
                    targetRotation.current += delta;
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(group.rotation, {
                        y: targetRotation.current,
                        duration: 1,
                        ease: "power1.out"
                    });
                }
            }["HomePage.useEffect.onWheel"];
            ...
            const onClick = {
                "HomePage.useEffect.onClick": ()=>{
                    raycasterRef.current.setFromCamera(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector2"](mouse.current.x, mouse.current.y), camera);
            ...
            const render = {
                "HomePage.useEffect.render": ()=>{
                    ...
                    if (intersects.length > 0) {
                        ...
                        planes.current.forEach({
                            "HomePage.useEffect.render": (plane)=>{
                                if (plane === hovered) {
                                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(plane.material, {
                                        opacity: 1,
                                        duration: 0.5
                                    });
                                } else {
...
_s(HomePage, "H6CDSilrgBskfFPr7yKQGWOraok=");
_c = HomePage;
var _c;
...
//# sourceMappingURL=src_components_utils_f463dd38._.js.map