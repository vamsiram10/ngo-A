 ...
 */ const WalkingDogWithPerson = ({ width = 300, height = 200, style = {}, className = "" })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WalkingDogWithPerson.useEffect": ()=>{
            let frame = 0;
            let raf;
            const animate = {
                "WalkingDogWithPerson.useEffect.animate": ()=>{
            ...
            raf = requestAnimationFrame(animate);
            return ({
                "WalkingDogWithPerson.useEffect": ()=>raf && cancelAnimationFrame(raf)
            })["WalkingDogWithPerson.useEffect"];
        }
    }["WalkingDogWithPerson.useEffect"], []);
...
_s(WalkingDogWithPerson, "JWNkVvqDwC3Xj+XwVC/OSsWa/OI=");
_c = WalkingDogWithPerson;
const __TURBOPACK__default__export__ = WalkingDogWithPerson;
var _c;
__turbopack_context__.k.register(_c, "WalkingDogWithPerson");
