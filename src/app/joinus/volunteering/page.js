    ...
    <>
      <main className="bg-black text-white">
        ...
        <section className="relative -mt-20 z-20">
            ...
            <div className="bg-black pt-28 pb-12"><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div className="relative bg-neutral-900 border border-neutral-800 rounded-3xl p-8 md:p-16 overflow-hidden"><div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_center,_rgba(107,33,168,0.08),_transparent_40%)]"></div><div className="absolute inset-0 -z-20 [mask-image:radial-gradient(ellipse_at_center,white,transparent)] bg-cover bg-[url('https://tailwindcss.com/_next/static/media/docs@tinypng.61f4d333_1x.png')] opacity-20"></div><h2 className="text-4xl font-bold text-pink-500 mb-16 text-center">Why Your Help Matters</h2><motion.div initial="hidden" whileInView="visible" variants={containerVariants} viewport={{ once: true, amount: 0.2 }} className="grid lg:grid-cols-3 gap-12 md:gap-16 items-center"><div className="lg:col-span-1 space-y-12 text-right"><FeaturePoint number="01" title="Make a Real Impact">Your work directly contributes to improving lives and strengthening communities.</FeaturePoint><FeaturePoint number="02" title="Develop New Skills">Gain valuable experience in leadership, communication, and project management.</FeaturePoint></div><motion.div variants={itemVariants} className="lg:col-span-1 flex justify-center items-center order-first lg:order-none"><div className="relative w-full max-w-xs aspect-square rounded-full overflow-hidden border-4 border-neutral-800 shadow-2xl"><Image src="/images/volunteer2.jpg" alt="A volunteer helping the community" layout="fill" objectFit="cover" /></div></motion.div><div className="lg:col-span-1 space-y-12 text-left"><FeaturePoint number="03" title="Join a Community">Connect with like-minded individuals who share your passion for social good.</FeaturePoint><FeaturePoint number="04" title="Flexible Commitment">Find roles that fit your schedule, from one-day events to ongoing projects.</FeaturePoint></div></motion.div></div></div></div>
        </section>
                    ...
                    {opportunities.map((item) => (
                        <motion.div key={item.id} variants={itemVariants} className="bg-neutral-900 rounded-xl flex flex-col border border-neutral-800 transition-all duration-300 hover:border-pink-500/80 hover:-translate-y-2 hover:shadow-2xl hover:shadow-pink-900/40 bg-[radial-gradient(circle_at_top,_rgba(236,72,153,0.08),_transparent_40%)]">
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto pt-4"><motion.button onClick={() => openModal(item)} whileHover={{ scale: 1.05 }} className="w-full bg-gradient-to-r from-pink-600 to-violet-600 hover:from-pink-500 hover:to-violet-500 text-white font-bold py-3 rounded-lg transition-all duration-300">View & Register</motion.button></div>
                            </div>
                        </motion.div>
                    ))}
                </motion.div>
