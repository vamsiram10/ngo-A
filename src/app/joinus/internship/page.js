...
export default function InternshipPage() {
  const opportunities = [
    { id: 1, img: "/images/Technical Intern.jpg", title: "Technical Intern", desc: "Help with website maintenance, data management, and IT support to keep our digital infrastructure strong and efficient.", duration: "1-3 months", formLink: "https://forms.gle/eM8hh64etLhw2fAy5" },
    ...
    { id: 3, img: "/images/Fundraising Intern.jpg", title: "Fundraising Intern", desc: "Support our fundraising efforts through research, outreach, and campaign assistance to help us reach our financial goals.", duration: "1-3 months", formLink: "https://forms.gle/eM8hh64etLhw2fAy5" },
    { id: 4, img: "/images/Content Writing Intern.jpg", title: "Content Writing Intern", desc: "Craft compelling articles, blog posts, and website content to share our story and the impact of our work.", duration: "1-3 months", formLink: "https://forms.gle/eM8hh64etLhw2fAy5" },
  ];
...
=======
    ...
    { id: 3, quote: "It was great working with Avasa Foundation; the guidance and environment here encouraged me to work harder. It was phenomenal, and I look forward to working here again", name: "Krishna Swami", role: "Former Content Writing Intern", avatar: "/images/avatar3.jpg" },
    { id: 4, quote: "This internship allowed me to discover my graphic design skills. I'm truly grateful to be a part of Avasa.", name: "Manthan jain", role: "Former Social Media Intern", avatar: "/images/avatar4.jpg" },
    { id: 5, quote: "I learned how to tailor my content impactfully. Heartfelt thanks to Team Avasa for this invaluable opportunity", name: "K Gayathri Devi", role: "Former Content Writing Intern", avatar: "/images/avatar5.jpg" },
    { id: 6, quote: "An amazing experience as a technical support intern at Avasa; it significantly boosted my confidence and allowed me to grow technically and professionally.", name: "B.Chandrashekar Reddy", role: "Former Technical Intern", avatar: "/images/avatar6.jpg" },
...
>>>>>>> 6c83b15b930a304eb14973d33128716b4ea4923e
  ];
        ...
        <div className="py-20 md:py-28">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex justify-center items-center gap-4 mt-8">
              ...
              <div className="flex justify-center items-center gap-2">{testimonials.map((_, index) => (<button key={index} onClick={() => setCurrentTestimonial(index)} className={`w-3 h-3 rounded-full transition-colors duration-300 ${currentTestimonial === index ? "bg-pink-500" : "bg-neutral-600"}`} aria-label={`Go to testimonial ${index + 1}`}></button>))}</div>
              <button onClick={nextTestimonial} className="bg-white/10 p-2 rounded-full hover:bg-white/20 transition-colors duration-300 md:hidden" aria-label="Next testimonial"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></button>
            </div>
          </div>
        </div>
