...
"[project]/src/components/utils/transitionlink/TransitionLink.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
// Utility for smooth sleep
function sleep(ms) {
    return new Promise((resolve)=>setTimeout(resolve, ms));
}
// Add a custom overlay with a white background and a centered image (page transition symbol)
function addSlideUpOverlay() {
    ...
    overlay.style.background = "#fff"; // White background
    overlay.style.animationDuration = "0.7s";
    overlay.style.animationTimingFunction = "cubic-bezier(0.77, 0, 0.175, 1)";
    overlay.style.display = "flex";
    overlay.style.alignItems = "center";
    overlay.style.justifyContent = "center";
    // Add the image in the exact center
    const img = document.createElement("img");
    img.src = "/svg/AVASA.svg"; // Use your page transition symbol here
...
// Inject the slide-up animation CSS if not already present
...
const TransitionLink = ({ children, href, ...props })=>{
    ...
    const handleTransition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (e)=>{
        // Only handle left click, no modifier keys, and internal links
        ...
        e.preventDefault();
        // Smoothly scroll to top before transition (if Lenis is available)
        if (lenis) {
        ...
        // Add the slide-up overlay
        addSlideUpOverlay();
        // Wait for the animation to reach the top (as soon as overlay covers the screen)
        await sleep(650);
        // Instantly navigate to the new page as soon as overlay reaches the top
        router.push(href);
        // Remove overlay after a short delay (in case of fast navigation)
...
const Navbar = ()=>{
    ...
    // We'll use a callback to ensure the menu closes after navigation
    const handleMobileNavClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
    ...
    const MobileTransitionLink = ({ href, children, ...props })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$utils$2f$transitionlink$2f$TransitionLink$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TransitionLink"], {
            href: href,
            ...props,
            onClick: (e)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7881e341._.js.map