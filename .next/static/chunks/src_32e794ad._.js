...
"[project]/src/components/utils/animatedcursor/AnimatedCursor.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnimatedCursor.useEffect": ()=>{
            ...
            const interval = setInterval({
                "AnimatedCursor.useEffect.interval": ()=>{
                    document.body.style.cursor = `url(${frames[index]}), auto`;
                    index = (index + 1) % frames.length;
                }
            }["AnimatedCursor.useEffect.interval"], 1000 / fps);
            // Cleanup on component unmount
            return ({
                "AnimatedCursor.useEffect": ()=>clearInterval(interval)
            })["AnimatedCursor.useEffect"];
        }
    }["AnimatedCursor.useEffect"], []);
    return null; // No visible JSX
}
_s(AnimatedCursor, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = AnimatedCursor;
var _c;
...
//# sourceMappingURL=src_32e794ad._.js.map